...
const showTask = async () => {
  try {
    ...
    const finishDateFormatted = `${finishDateObj.getDate()}/${finishDateObj.getMonth() + 1}/${finishDateObj.getFullYear()}`
    taskDateDOM.textContent = finishDateFormatted
    taskDetailsDOM.textContent = details
